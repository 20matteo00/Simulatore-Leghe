...
function calcola($s1, $s2, $c1, $c2, $coppa) {
    ...
    $sql1 = "SELECT * from squadra WHERE squadra.ID = '$s1' AND squadra.ID_Campionato = '$c1'";
        ...
        if(($ga1+$gr1+$r1)>($ga2+$gr2+$r2)){
            $sql = "UPDATE QCL SET Eliminato=15 WHERE ID_Squadra='$s2' AND ID_Campionato='$c2'";
            $sql1 = "UPDATE GCL SET Eliminato=15 WHERE ID_Squadra='$s2' AND ID_Campionato='$c2'";
            ...
            $sql = "UPDATE QCL SET Eliminato=15 WHERE ID_Squadra='$s1' AND ID_Campionato='$c1'";
            $sql1 = "UPDATE GCL SET Eliminato=15 WHERE ID_Squadra='$s1' AND ID_Campionato='$c1'";
