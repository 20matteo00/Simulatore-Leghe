...
$sql2 = "SELECT * FROM GCL, squadra WHERE GCL.ID_Squadra=squadra.ID AND GCL.ID_Campionato=squadra.ID_Campionato AND (Eliminato=0 OR Eliminato>=50)";
...
$sql3 = "SELECT * FROM QCL, squadra WHERE QCL.ID_Squadra=squadra.ID AND QCL.ID_Campionato=squadra.ID_Campionato AND (Eliminato=0 OR Eliminato>=50)";
