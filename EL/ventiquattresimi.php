...
// Esegui una query per ottenere le squadre qualificate dalla tabella QEL
$sql1 = "SELECT squadra.*
		FROM QEL, squadra
...
$numero_squadre_el = count($squadre_qualificate);
...
<div class="container">
    <h1 class="mt-5">Qualificazioni Europa League</h1>
    <h3 class="text-center">Ventiquattresimi <a class="btn btn-primary" href="dodicesimi.php">Avanti</a></h3>
    <table class="table table-bordered ">
        <thead>
            <tr>
                ...
                <th id="colsim" class="text-center">
                    <form class="mb-0" method="get" action="simulaventiquattresimi.php">
        ...
        <tbody>
            <?php
                ...
                $numero_accoppiamenti = $numero_squadre_el / 2;
                for ($i = 0; $i < $numero_accoppiamenti; $i++) {

                    $squadra_casa = $squadre_qualificate[$i];
                    $squadra_trasferta = $squadre_qualificate[$numero_squadre_el - $i - 1];
