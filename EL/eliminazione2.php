...
$sql2 = "SELECT * FROM GEL, squadra WHERE GEL.ID_Squadra=squadra.ID AND GEL.ID_Campionato=squadra.ID_Campionato AND (Eliminato=0 OR Eliminato>=25)";
...
$sql3 = "SELECT * FROM QEL, squadra WHERE QEL.ID_Squadra=squadra.ID AND QEL.ID_Campionato=squadra.ID_Campionato AND (Eliminato=0 OR Eliminato>=25)";
