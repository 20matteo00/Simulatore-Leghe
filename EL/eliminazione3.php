...
$sql = "SELECT count(*) as total FROM partitaelim where coppa=1";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
if ($row['total'] < 24) {
    header ("Location: eliminazione2.php");
}
...
$sql2 = "SELECT * FROM GEL, squadra WHERE GEL.ID_Squadra=squadra.ID AND GEL.ID_Campionato=squadra.ID_Campionato AND (Eliminato=0 OR Eliminato>=50)";
...
$sql3 = "SELECT * FROM QEL, squadra WHERE QEL.ID_Squadra=squadra.ID AND QEL.ID_Campionato=squadra.ID_Campionato AND (Eliminato=0 OR Eliminato>=50)";
...
<div class="container">
    ...
    <h3 class="text-center">Semifinale <a class="btn btn-primary" href="eliminazione4.php">Avanti</a></h3>
        ...
        <thead>
            <tr>
                ...
                <th id="colsim" class="text-center">
                    <form class="mb-0" method="get" action="simulaeliminazione3.php">
