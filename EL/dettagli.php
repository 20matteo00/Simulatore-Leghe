...
$sql = "SELECT count(*) as total FROM squadragirone where Coppa=1";
...
echo '<div class="container-fluid">';
    for ($i = 0; $i < 8; $i++) {
        ...
        $sql2 = 'SELECT squadra.Nome, squadra.Forza, statistichegirone.*
                ...
                and statistichegirone.Girone = "'.$girone.'" and statistichegirone.Coppa = 1
        ...
        echo '<a class="link-underline link-underline-opacity-0" href="simulagironi.php?Coppa=1&Girone='.$girone.'">Simula</a>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        ...
        $sql3 = 'SELECT squadra.ID, LEFT(squadra.Nome, 4) AS NomeAbbreviato, squadra.Nome, squadra.ID_Campionato FROM squadra, squadragirone WHERE  squadra.ID = squadragirone.ID_Squadra and squadra.ID_Campionato = squadragirone.ID_Campionato   and squadragirone.Coppa = 1 and squadragirone.Girone = "' .$girone. '" ORDER BY NomeAbbreviato';
...
<?php
        ...
        echo '</div>';
        echo '<div class="row mb-4">';
        $sql4 = "SELECT squadra.Nome, squadra.ID, squadra.ID_Campionato FROM squadra, squadragirone WHERE squadra.ID = squadragirone.ID_Squadra and squadra.ID_Campionato = squadragirone.ID_Campionato and squadragirone.Coppa = 1 and squadragirone.Girone = '" .$girone. "' ORDER BY squadra.Nome";
