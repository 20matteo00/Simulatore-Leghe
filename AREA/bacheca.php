...
<body>
    <?php include("conn.php"); include("TAG/header.php"); include("TAG/navbarbacheca.php"); include("Script/stats.php");?>
    <div class="container-fluid mt-5">
        <div class="row">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "</div>";
                echo "<div class='card-footer text-center' id='cardhf'><a class='link-underline link-underline-opacity-0' href='/AREA/Script/simula.php?ID=" . $row['ID'] . "'>Simula</a></div>";
                echo "</div>";
                echo "</div>";
