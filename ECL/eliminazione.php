...
$sql = "SELECT count(*) as total FROM partitagirone where coppa=2";
...
$sql2 = "SELECT * FROM QECL WHERE Eliminato=0";
...
for ($i = 0; $i < count($gironi); $i++) {
    ...
    $sql4 = "SELECT squadra.* FROM statistichegirone, squadra WHERE squadra.ID=statistichegirone.ID_Squadra AND squadra.ID_Campionato=statistichegirone.ID_Campionato AND Coppa = 2 AND Girone = '$gironi[$i]' ORDER BY Pt DESC, DR DESC, GF DESC LIMIT 2 OFFSET 2";
    ...
    while ($row4 = $result4->fetch_assoc()) {
        ...
        $sql5 = "UPDATE QECL SET Eliminato=10 WHERE ID_Squadra='$idSquadra' AND ID_Campionato='$idCampionato'";
