...
// Esegui una query per ottenere le squadre qualificate dalla tabella QECL
$sql1 = "SELECT squadra.*
		FROM QECL, squadra
...
<div class="container">
    <h1 class="mt-5">Qualificazioni Conference League</h1>
            <h3 class="text-center">Trentaduesimi <a class="btn btn-primary" href="qualificati.php"  >Avanti</a></h3>
                ...
                <thead>
                    <tr>
                        ...
                        <th id="colsim" class="text-center">
                        	<form class="mb-0" method="get" action="simulatrentaduesimi.php">
